...
export async function generateMetadata({ params }: LegalPageProps): Promise<Metadata> {
  try {
    ...
    const title = page.metadata?.metaTitle || `${page.title} | NeoGraph Analytics`;
...
export default async function LegalDetailPage({ params }: LegalPageProps) {
  ...
  const articleSchema = generateArticleSchema({
    ...
    url: `https://www.neographanalytics.com/legal/${page.slug}`,
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Legal', url: 'https://www.neographanalytics.com/legal' },
    { name: page.title, url: `https://www.neographanalytics.com/legal/${page.slug}` },
  ]);
        ...
        <Container size="sm">
          ...
          <div className="mt-16 pt-8 border-t border-[var(--border)] text-center">
            ...
            <p className="text-lg">
              Contact us at{' '}
              <a
                href="mailto:support@neographanalytics.com"
                className="text-[var(--primary)] hover:underline font-medium"
              >
                support@neographanalytics.com
              </a>
            </p>
          </div>
        </Container>
