...
import { getReportBySlug } from '@/lib/api/reports';
...
export async function generateMetadata({
  ...
  const result = await getReportBySlug(reportSlug);
  if (!result.success) return { title: 'Checkout' };
  return {
    title: `Checkout — ${result.data.title}`,
